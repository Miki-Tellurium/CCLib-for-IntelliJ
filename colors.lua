...
---@generic Constants and functions for colour values, suitable for working with term and redstone.
...
--- exactly the same, except the colours use British English (e.g. colors.gray
